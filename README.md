...
- **打字练习**：逐字母输入、正误高亮、虚拟键盘按键高亮，配 8 指 8 色的线稿虚拟双手指法指引（键盘 / 手势指引均可在设置中关闭，适合进阶用户）
...
- **自定义词表**：家长 / 老师可下载 CSV 模板，用 Excel/WPS 填写并另存为 CSV UTF-8 后上传；也支持 .txt（每行一词）。内置已有词可加入自选词表并共享学习进度，新词可附释义、音标，与内置词库同一练习 / SRS / 错题本链路
